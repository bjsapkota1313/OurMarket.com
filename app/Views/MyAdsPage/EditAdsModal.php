<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
     aria-labelledby="edit-modal-label" aria-hidden="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit-modal-label">Edit Your Ad</h5>
                <button id="buttonCloseEditModal" type="reset" class="btn-close" data-bs-dismiss="modal"
                ...
                <div id="edit-form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file"  class="form-control-file" id="AdEditImageInput" name="image" accept="image/png, image/jpeg,image/jpg"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="AdEditDescription"
